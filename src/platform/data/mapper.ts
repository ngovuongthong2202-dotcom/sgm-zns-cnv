...
export const mapDocument = <T>(row: Record<string, unknown> | null | undefined): T => {
  ...
  return {
    ...
    maBaoGia: (row.ma_bao_gia as string) || (row.maBaoGia as string) || (jsonb.maBaoGia as string) || (jsonb.soPhieuBaoGia as string) || undefined,
    soPhieuBaoGia: (jsonb.soPhieuBaoGia as string) || (row.ma_bao_gia as string) || (row.maBaoGia as string) || (jsonb.maBaoGia as string) || undefined,
    maHopDong: (row.ma_hop_dong as string) || (row.maHopDong as string) || (jsonb.maHopDong as string) || (jsonb.soHopDong as string) || undefined,
    soHopDong: (jsonb.soHopDong as string) || (row.ma_hop_dong as string) || (row.maHopDong as string) || (jsonb.maHopDong as string) || undefined,
